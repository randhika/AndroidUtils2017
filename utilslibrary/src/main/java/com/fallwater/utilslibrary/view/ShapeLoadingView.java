...
public class ShapeLoadingView extends View {
    ...
    private void init() {
        mPaint = new Paint();
        mPaint.setColor(ContextCompat.getColor(mContext, R.color.loading_triangle));
        mPaint.setAntiAlias(true);
        mPaint.setStyle(Paint.Style.FILL_AND_STROKE);
        setBackgroundColor(ContextCompat.getColor(mContext, R.color.view_bg));
        mTriangleColor = ContextCompat.getColor(mContext, R.color.loading_triangle);
        mCircleColor = ContextCompat.getColor(mContext, R.color.loading_circle);
        mRectColor = ContextCompat.getColor(mContext, R.color.loading_rect);
    }
        ...
        switch (mShape) {
            case SHAPE_TRIANGLE:
                if (mIsLoading) {
                    ...
                    int color = (int) mArgbEvaluator
                            .evaluate(mAnimPercent, mTriangleColor, mCircleColor);
            ...
            case SHAPE_CIRCLE:
                if (mIsLoading) {
                    ...
                    int color = (int) mArgbEvaluator
                            .evaluate(mAnimPercent, mCircleColor, mRectColor);
                    mPaint.setColor(color);
                    Path path = new Path();
                    path.moveTo(relativeXFromView(0.5f), relativeYFromView(0f));
                    ...
                    mPaint.setColor(ContextCompat.getColor(mContext, R.color.loading_circle));
                    Path path = new Path();
            ...
            case SHAPE_RECT:
                if (mIsLoading) {
                    ...
                    int color = (int) mArgbEvaluator
                            .evaluate(mAnimPercent, mRectColor, mTriangleColor);
                    mPaint.setColor(color);
                    Path path = new Path();
                    ...
                    mPaint.setColor(ContextCompat.getColor(mContext, R.color.loading_rect));
