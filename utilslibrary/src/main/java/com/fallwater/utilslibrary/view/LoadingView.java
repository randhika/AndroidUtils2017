 ...
 * 功能描述:loadingview，用于网络请求时，展示的加载中动画
 */
public class LoadingView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextAppearance = typedArray
                .getResourceId(R.styleable.LoadingView_loadingTextAppearance, -1);
    ...
    public void throwUp() {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator
                .ofFloat(mShapeLoadingView, "translationY", mDistance, 0);
    ...
    public void fallDown() {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator
                .ofFloat(mShapeLoadingView, "translationY", 0, mDistance);
