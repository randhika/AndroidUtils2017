...
public class FragmentUtils {
    ...
    public static void showFragment(FragmentManager manager, Fragment fragment,
        ...
        showFragment(manager, fragment, addToBackStack, R.id.fragment_container, false,
    ...
    public static void showFragmentAllowingStateLoss(FragmentManager manager, Fragment fragment,
            boolean addToBackStack) {
        showFragment(manager, fragment, addToBackStack, R.id.fragment_container, true,
                R.anim.slide_in_left, R.anim.slide_out_right, R.anim.pop_enter, R.anim.pop_exit);
    }
    ...
    public static void showFragmentWithOutAnimation(FragmentManager manager, Fragment fragment,
        ...
        showFragment(manager, fragment, addToBackStack, R.id.fragment_container, commitStateLoss);
    }
    ...
    public static void showFragmentWithCustomAnimation(FragmentManager manager, Fragment fragment,
        ...
        showFragment(manager, fragment, addToBackStack, R.id.fragment_container, false, animations);
    }
